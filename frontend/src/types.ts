...
export interface Session { id: string; user_id: string; agent_config_id: string; model: string; credential_id: string | null; title: string | null; work_subdir: string; last_active_at: string; last_context_tokens: number | null }
