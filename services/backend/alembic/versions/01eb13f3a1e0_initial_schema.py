...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_context_documents_owner_id"), "context_documents", ["owner_id"], unique=False
    )
    op.create_table(
        "memory_entries",
        sa.Column("id", sa.Uuid(), nullable=False),
    ...
    op.create_index(
        op.f("ix_memory_entries_owner_id"), "memory_entries", ["owner_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_sessions_agent_config_id"), "sessions", ["agent_config_id"], unique=False
    )
